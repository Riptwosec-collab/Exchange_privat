...
export const stockUniverse: StockMeta[] = [
  ...
  { ticker: "TSM", name: "Taiwan Semiconductor Manufacturing Company Ltd.", sector: "Semiconductor", marketCap: "1.0T", logoUrl: favicon("tsmc.com"), logoFallback: "TSM", brandColor: "#e42313" },
  { ticker: "MSFT", name: "Microsoft Corporation", sector: "AI/Cloud", marketCap: "3.1T", logoUrl: simpleIcon("microsoft", "ffffff"), logoFallback: "MS", brandColor: "#0078d4" },
  { ticker: "GOOGL", name: "Alphabet Inc. (Google) Class A", sector: "AI/Search", marketCap: "2.1T", logoUrl: simpleIcon("google", "4285f4"), logoFallback: "G", brandColor: "#ffffff" },
...
const fundamentals: Record<string, FundamentalMeta> = {
  ...
  TSM: { peRatio: 28.4, revenueGrowth: 34.6, dividendYield: 1.3, isAiStock: true },
  MSFT: { peRatio: 35.2, revenueGrowth: 17.0, dividendYield: 0.7, isAiStock: true },
  GOOGL: { peRatio: 27.4, revenueGrowth: 14.1, dividendYield: 0.4, isAiStock: true },
